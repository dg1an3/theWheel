...
make up your GEOM_VIEW application.

/////////////////////////////////////////////////////////////////////////////

StdAfx.h, StdAfx.cpp
    These files are used to build a precompiled header (PCH) file
    named GEOM_VIEW.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "GEOM_VIEW.rc" and a "GEOM_VIEW.h" that 
