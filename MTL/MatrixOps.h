...
{
	ASSERT(mLeft.GetCols() == vRight.GetDim());
	ASSERT(vProd.GetDim() == mLeft.GetRows());
	...
	for (int nRow = 0; nRow < mLeft.GetRows(); nRow++)
	{
		...
		{
			vProd[nRow] += mLeft[nCol][nRow] * vRight[nCol];
		}
	}
}
...
template<class MATRIX_TYPE> __forceinline
void MultMatrixMatrix(MATRIX_TYPE& mProd, const MATRIX_TYPE& mLeft, 
...
BOOL IsOrthogonal(const MATRIX_TYPE& mMat)
{
...
//////////////////////////////////////////////////////////////////////
template<class MATRIX_TYPE>
void Orthogonalize(MATRIX_TYPE& mMat)
{
...
//////////////////////////////////////////////////////////////////////
template<class MATRIX_TYPE>
BOOL Invert(MATRIX_TYPE& mMat, BOOL bFullPivot = FALSE)
{
...
//////////////////////////////////////////////////////////////////////
template<class MATRIX_TYPE>
void InterchangeRows(MATRIX_TYPE& mMat, int nRow1, int nRow2) 
{
...
//////////////////////////////////////////////////////////////////////
template<class MATRIX_TYPE>
void InterchangeCols(MATRIX_TYPE& mMat, int nCol1, int nCol2) 
{
...
//////////////////////////////////////////////////////////////////////
template<class MATRIX_TYPE>
int FindPivotRow(MATRIX_TYPE& mMat, int nDiag)
{
...
//////////////////////////////////////////////////////////////////////
template<class MATRIX_TYPE>
void FindPivotElem(MATRIX_TYPE& mMat, int nDiag, int *pBestRow, int *pBestCol)
{
	(*pBestCol) = nDiag;
	(*pBestRow) = nDiag;
...
//////////////////////////////////////////////////////////////////////
template<class MATRIX_TYPE>
void TraceMatrix(const char *pszMessage, const MATRIX_TYPE& m)
{
	TRACE("%s = \n", pszMessage);
