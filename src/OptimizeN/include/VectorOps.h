...
{													
	float length;									
	CK_IPP(ippmL2Norm_v_32f(pV, &length, nLength));
...
{													
	double length;									
	CK_IPP(ippmL2Norm_v_64f(pV, &length, nLength));
...
{															
	float prod;
	CK_IPP(ippmDotProduct_vv_32f(vLeft, vRight, 
		&prod, nLength));
...
{															
	double prod;
	CK_IPP(ippmDotProduct_vv_64f(vLeft, vRight, 
		&prod, nLength));
