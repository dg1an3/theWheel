========================================================================
    STATIC LIBRARY : theWheelView Project Overview
========================================================================

AppWizard has created this theWheelView library project for you. 

This file contains a summary of what you will find in each of the files that
make up your theWheelView application.
...
StdAfx.h, StdAfx.cpp
    ...
    named theWheelView.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "theWheelView.rc" and a "theWheelView.h" that 
