...
// $Id: RuntimeTracker.cpp,v 1.7 2007/06/04 02:46:26 Derek Lane Exp $
// U.S. Patent Pending
//////////////////////////////////////////////////////////////////////
...
HRESULT CRuntimeTracker::OpenUrl(const CString &strUrl)
{
	...
	if (!m_pBrowser)
	{
		CHECK_HRESULT(::CoCreateInstance(CLSID_InternetExplorer,
	...
	CHECK_HRESULT(m_pBrowser->put_Visible(_variant_t(true)));
