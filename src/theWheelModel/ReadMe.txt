========================================================================
    STATIC LIBRARY : theWheelModel Project Overview
========================================================================

AppWizard has created this theWheelModel library project for you. 

This file contains a summary of what you will find in each of the files that
make up your theWheelModel application.


theWheelModel.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    named theWheelModel.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "theWheelModel.rc" and a "theWheelModel.h" that 
